...
<p id="para2"> Home  AboutUs  Shop </p>
<form action="" method="post">
<form>
<h1 id="reg"><b>Registration Form </b></h1><hr>
<table width=450px border=2px class="card2">
<tr>
 <td> <label for="firstname">First name:</label><br></td>
 <td> <input type="text" id="firstname" name="firstname" minlength="4" ></td>
</tr>
<tr>
 <td><label for="lastname">Last name:</label></td>
 <td><input type="text" id="lastname" name="lastname" minlength="4"></td>
</tr>
<tr>
...
<tr>
  ...
  <td><input type="password" id="pw" name="pw" minlength="5"></td>
</tr>
<tr>
<td>
